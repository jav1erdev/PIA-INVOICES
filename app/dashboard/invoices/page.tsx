  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
        <Search
          placeholder="Buscar facturas (por Id, Estado, Fecha de creacion, Nombre del Cliente o Correo Electronico del Cliente)..."
      ...
      <Suspense
        ...
        fallback={<InvoicesTableSkeleton theme={theme || defaultTheme} />}
      >
        <InvoicesServerTable
          query={query}
